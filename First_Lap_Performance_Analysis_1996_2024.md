...
I don't have much to say other than Jos Verstappens figures are nothing but a class of their own, the best comparison I have is Alonso's 2006 season. His first lap starts are nothing but in the best of his class at those starting positions, while the 2001 season is absolutely shockingly impressive. Jan Magnussen's 1998 and Scott Speed's 2007 seasons are standing out by themselves, but are nowere close to Jos. I initially thought it would be a challenge to numerically differ between the best Lap 1 performers and at this stage I think there is no question to be asked. It is Jos Verstappen. A dirty statistical solution would be to do a non-linear regression of the data and build a 2D-distribution that takes the data skewness into account, but I do not think it would produce a robust model.
...
# 2.4.1. Seasonal results: The greatest first lap performers ever. Jos Verstappen, Jan Magnussen and Scott Speed
